...
import com.example.listapokemons.data.api.model.Pokemon
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int,
        ...
        return try {
            ...
            val pokemons = response.results.map { pokemon ->
                //val imageUrl = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokem on/${pokeId}.png"
                val imageUrl =
